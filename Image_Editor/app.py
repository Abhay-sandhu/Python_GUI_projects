...
class Image_Editor(QWidget):
    ...
    def load_filter(self, filter_name):
        if filter_name == "Original":
            ...
            filter_map = {
                "Left": lambda image: image.transpose(Image.Transpose.ROTATE_270),
                "Right": lambda image: image.transpose(Image.Transpose.ROTATE_90),
                "Mirror": lambda image: image.transpose(
                ...
                "Color Saturation": lambda image: ImageEnhance.Color(image).enhance(
                    1.2
                ),
